...
if($_SERVER['REQUEST_METHOD'] == 'GET')
{
	...
	$query = 'SELECT partStock.ManufacturerPartId,partStock.OrderReference FROM partStock LEFT JOIN productionPart ON partStock.ManufacturerPartId = productionPart.ManufacturerPartId WHERE (partStock.OrderReference != productionPart.PartNo OR (productionPart.PartNo IS NULL AND partStock.OrderReference IS NOT NULL)) AND partStock.OrderReference != ""  GROUP BY partStock.ManufacturerPartId,partStock.OrderReference';
	$queryResult = dbRunQuery($dbLink,$query);
