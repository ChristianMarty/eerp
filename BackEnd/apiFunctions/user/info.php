...
if($devMode) // TODO: This is fundamentally broken -> fix it
{
	...
	$json =  '{"inventory": { "print": true,"create": true},"purchasing":{"create": true, "edit": true, "confirm": true},"supplier":{"view": true},"supplierPart":{"create": true},"process":{"run": true},"document":{"create": true},"manufacturerPart":{"create": true,"edit": true},"stock":{"create": true, "add": true, "remove":true, "count":true}}';
