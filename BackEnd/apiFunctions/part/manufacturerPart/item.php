...
if($_SERVER['REQUEST_METHOD'] == 'GET')
{
    ...
    $query = <<<STR
        SELECT manufacturerPart_item.Id AS PartId, vendor.name AS ManufacturerName, manufacturerPart_item.Number AS PartNumber, Attribute,
                   ...
                   manufacturerPart_item.SeriesId AS SeriesId, manufacturerPart_series.Title AS SeriesTitle, manufacturerPart_series.Description AS SeriesDescription
    ...
    $query = <<<STR
        SELECT manufacturerPart_partNumber.Number AS ManufacturerPartNumber, productionPart.Number AS ProductionPartNumber, numbering.Prefix AS ProductionPartNumberPrefix
