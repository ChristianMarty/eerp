...
if($_SERVER['REQUEST_METHOD'] == 'GET')
{
    ...
    $baseQuery = <<<STR
        SELECT 
            ...
            manufacturerPart_class_getName(manufacturerPart_class.Id) AS PartClassName 
        ...
        LEFT JOIN manufacturerPart_class On manufacturerPart_class.Id = manufacturerPart.PartClassId
    STR;
