CREATE TABLE `purchaseOrder_additionalCharges` (
	...
	`Type` ENUM('Shipping','Packaging','Handling','Other','Discount','Rounding','Import Tax') NULL DEFAULT NULL,
	...
	PRIMARY KEY (`Id`),
	INDEX `FK_purchasOrder_additionalCharges_finance_tax` (`VatTaxId`),
	INDEX `FK_purchasOrder_additionalCharges_purchasOrder` (`PurchaseOrderId`),
	INDEX `FK_purchaseOrder_additionalCharges_user` (`CreationUserId`),
