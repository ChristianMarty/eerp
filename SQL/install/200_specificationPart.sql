CREATE TABLE `specificationPart` (
	...
	`SpecificationPartNumber` INT(5) UNSIGNED ZEROFILL NOT NULL DEFAULT (cast(rand() * 100000 as unsigned)),
	...
	PRIMARY KEY (`Id`),
	UNIQUE KEY `SpecificationPartNumber` (`SpecificationPartNumber`),
