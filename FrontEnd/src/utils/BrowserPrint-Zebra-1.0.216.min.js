var $jscomp = $jscomp || {}; $jscomp.scope = {}; $jscomp.ASSUME_ES5 = !1; $jscomp.ASSUME_NO_NATIVE_MAP = !1; $jscomp.ASSUME_NO_NATIVE_SET = !1; $jscomp.defineProperty = $jscomp.ASSUME_ES5 || typeof Object.defineProperties === 'function' ? Object.defineProperty : function(e, h, g) { e != Array.prototype && e != Object.prototype && (e[h] = g.value) }; $jscomp.getGlobal = function(e) { return typeof window !== 'undefined' && window === e ? e : typeof global !== 'undefined' && global != null ? global : e }; $jscomp.global = $jscomp.getGlobal(this); $jscomp.SYMBOL_PREFIX = 'jscomp_symbol_'
...
$jscomp.initSymbolIterator = function() { $jscomp.initSymbol(); var e = $jscomp.global.Symbol.iterator; e || (e = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol('iterator')); typeof Array.prototype[e] !== 'function' && $jscomp.defineProperty(Array.prototype, e, { configurable: !0, writable: !0, value: function() { return $jscomp.arrayIterator(this) } }); $jscomp.initSymbolIterator = function() {} }; $jscomp.arrayIterator = function(e) { var h = 0; return $jscomp.iteratorPrototype(function() { return h < e.length ? { done: !1, value: e[h++] } : { done: !0 } }) }
...
$jscomp.polyfill = function(e, h, g, l) { if (h) { g = $jscomp.global; e = e.split('.'); for (l = 0; l < e.length - 1; l++) { var c = e[l]; c in g || (g[c] = {}); g = g[c] }e = e[e.length - 1]; l = g[e]; h = h(l); h != l && h != null && $jscomp.defineProperty(g, e, { configurable: !0, writable: !0, value: h }) } }; $jscomp.FORCE_POLYFILL_PROMISE = !1
$jscomp.polyfill('Promise', function(e) {
  function h() { this.batch_ = null } function g(b) { return b instanceof c ? b : new c(function(a, f) { a(b) }) } if (e && !$jscomp.FORCE_POLYFILL_PROMISE) return e; h.prototype.asyncExecute = function(b) { this.batch_ == null && (this.batch_ = [], this.asyncExecuteBatch_()); this.batch_.push(b); return this }; h.prototype.asyncExecuteBatch_ = function() { var b = this; this.asyncExecuteFunction(function() { b.executeBatch_() }) }; var l = $jscomp.global.setTimeout; h.prototype.asyncExecuteFunction = function(b) {
    l(b,
      0)
...
function() { function b(b) { return function(k) { f || (f = !0, b.call(a, k)) } } var a = this; var f = !1; return { resolve: b(this.resolveTo_), reject: b(this.reject_) } }; c.prototype.resolveTo_ = function(b) { if (b === this) this.reject_(new TypeError('A Promise cannot resolve to itself')); else if (b instanceof c) this.settleSameAsPromise_(b); else { a:switch (typeof b) { case 'object':var a = b != null; break a; case 'function':a = !0; break a; default:a = !1 }a ? this.resolveToNonPromiseObj_(b) : this.fulfill_(b) } }; c.prototype.resolveToNonPromiseObj_ = function(b) {
    var a =
void 0; try { a = b.then } catch (f) { this.reject_(f); return } typeof a === 'function' ? this.settleSameAsThenable_(a, b) : this.fulfill_(b)
  }; c.prototype.reject_ = function(b) { this.settle_(2, b) }; c.prototype.fulfill_ = function(b) { this.settle_(1, b) }; c.prototype.settle_ = function(b, a) { if (this.state_ != 0) throw Error('Cannot settle(' + b + ', ' + a | '): Promise already settled in state' + this.state_); this.state_ = b; this.result_ = a; this.executeOnSettledCallbacks_() }; c.prototype.executeOnSettledCallbacks_ = function() {
...
this.onSettledCallbacks_, a = 0; a < b.length; ++a)b[a].call(), b[a] = null; this.onSettledCallbacks_ = null
    ...
    function f(a, f) { return typeof a === 'function' ? function(f) { try { k(a(f)) } catch (n) { d(n) } } : f } var k; var d; var e = new c(function(a,
      f) { k = a; d = f }); this.callWhenSettled_(f(b, k), f(a, d)); return e
  }; c.prototype.catch = function(b) { return this.then(void 0, b) }; c.prototype.callWhenSettled_ = function(b, a) { function f() { switch (k.state_) { case 1:b(k.result_); break; case 2:a(k.result_); break; default:throw Error('Unexpected state: ' + k.state_) } } var k = this; this.onSettledCallbacks_ == null ? d.asyncExecute(f) : this.onSettledCallbacks_.push(function() { d.asyncExecute(f) }) }; c.resolve = g; c.reject = function(b) { return new c(function(a, f) { f(b) }) }; c.race = function(b) {
    return new c(function(a,
      f) { for (var k = $jscomp.makeIterator(b), d = k.next(); !d.done; d = k.next())g(d.value).callWhenSettled_(a, f) })
  }; c.all = function(b) { var a = $jscomp.makeIterator(b); var f = a.next(); return f.done ? g([]) : new c(function(b, d) { function k(a) { return function(f) { c[a] = f; e--; e == 0 && b(c) } } var c = []; var e = 0; do c.push(void 0), e++, g(f.value).callWhenSettled_(k(c.length - 1), d), f = a.next(); while (!f.done) }) }; return c
}, 'es6', 'es3'); function dbg(e) {}
var Zebra = (function() {
  function e(c, d) { if (d instanceof g.Printer.Status && l[c.device.uid]) { if (d.offline) { if (c.errors++, c.errors < c.errorsForOffline) return } else c.errors = 0; var b = l[c.device.uid].status; var a = JSON.stringify(b); c.status = d; statusStr = JSON.stringify(d); if (statusStr !== a)c.onchange(b, d) } } function h(c) { return c.charCodeAt(0) !== 2 || c.charCodeAt(c.length - 1) !== 3 ? (dbg('Response did not contain proper control characters'), !1) : !0 } var g = {}; var l = {}; setInterval(function() {
    for (var c in l) {
      l.hasOwnProperty(c) && (c =
l[c], (function(d) { d.device.getStatus(function(b) { e(d, b) }, function(b) { e(d, new g.Printer.Status('')) }) }(c)))
    ...
    BrowserPrint.Device.call(this, c); g.Printer.Status = function(a) {
      this.raw = a; this.isFlagSet = function(a) { return this.raw.charAt(a) === '1' }; this.offline = !1; a || (a = ''); a = a.trim(); h(a) ? (this.offline = !1, this.paperOut = this.isFlagSet(5), this.paused = this.isFlagSet(7), this.headOpen = this.isFlagSet(43), this.ribbonOut = this.isFlagSet(45)) : (this.offline = !0, this.ribbonOut = this.headOpen = this.paused =
this.paperOut = !1); this.isPrinterReady = function() { return !(this.paperOut || this.paused || this.headOpen || this.ribbonOut || this.offline) }; this.getMessage = function() { return this.isPrinterReady() ? 'Ready' : this.offline ? 'Offline' : this.paperOut ? 'Paper Out' : this.headOpen ? 'Head Open' : this.ribbonOut ? 'Ribbon Out' : this.paused ? 'Paused' : 'Ready' }
    ...
    g.Printer.Configuration = function(a) {
      if (!a) throw 'Invalid Response'; this.raw = a = a.trim(); this.settings = {}; if (!h(a)) throw 'Invalid Response'; a = a.replace(String.fromCharCode(2), ''); a = a.replace(String.fromCharCode(3), ''); a = a.split('\n'); for (var f = 0; f < a.length; ++f) { var b = a[f].trim(); var d = b.substring(20); b = b.substring(0, 20).trim(); this.settings[d] = b } this.darkness = parseFloat(this.settings.DARKNESS); this.printSpeed = parseInt(this.settings['PRINT SPEED'].replace('IPS', '').trim()); this.printWidth = parseInt(this.settings['PRINT WIDTH'])
...
d.device_request_queue.length); d.device_request_queue.length > 0 && (dbg('Executing next request...'), d.device_request_queue[0].execute())
    }; this.queueRequest = function(a) { dbg('Queueing request ' + a.type + ': ' + d.device_request_queue.length); d.device_request_queue.push(a); d.device_request_queue.length === 1 && a.execute() }; this.onStatusResponse = function(a) {
      dbg('received status response'); var f = void 0; try { f = new g.Printer.Status(a) } catch (k) { a = d.device_request_queue[0], a.error(k), d.executeNextRequest() } for (;d.device_request_queue.length > 0;) {
        if (a =
d.device_request_queue[0], a.type === 'status')dbg('delivering status...'), a.success(f), d.device_request_queue.shift(); else { dbg('delivered to all status requests.'); break }
      }d.executeRequest()
