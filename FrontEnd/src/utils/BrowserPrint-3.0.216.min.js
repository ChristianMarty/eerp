var $jscomp = $jscomp || {}; $jscomp.scope = {}; $jscomp.checkStringArgs = function(b, h, c) { if (b == null) throw new TypeError("The 'this' value for String.prototype." + c + ' must not be null or undefined'); if (h instanceof RegExp) throw new TypeError('First argument to String.prototype.' + c + ' must not be a regular expression'); return b + '' }; $jscomp.ASSUME_ES5 = !1; $jscomp.ASSUME_NO_NATIVE_MAP = !1; $jscomp.ASSUME_NO_NATIVE_SET = !1
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || typeof Object.defineProperties === 'function' ? Object.defineProperty : function(b, h, c) { b != Array.prototype && b != Object.prototype && (b[h] = c.value) }; $jscomp.getGlobal = function(b) { return typeof window !== 'undefined' && window === b ? b : typeof global !== 'undefined' && global != null ? global : b }; $jscomp.global = $jscomp.getGlobal(this)
$jscomp.polyfill = function(b, h, c, e) { if (h) { c = $jscomp.global; b = b.split('.'); for (e = 0; e < b.length - 1; e++) { var k = b[e]; k in c || (c[k] = {}); c = c[k] } b = b[b.length - 1]; e = c[b]; h = h(e); h != e && h != null && $jscomp.defineProperty(c, b, { configurable: !0, writable: !0, value: h }) } }
$jscomp.polyfill('String.prototype.startsWith', function(b) { return b || function(b, c) { var e = $jscomp.checkStringArgs(this, b, 'startsWith'); b += ''; var h = e.length; var p = b.length; c = Math.max(0, Math.min(c | 0, e.length)); for (var l = 0; l < p && c < h;) if (e[c++] != b[l++]) return !1; return l >= p } }, 'es6', 'es3')
var BrowserPrint = (function() {
  function b(a, b) { var d = new XMLHttpRequest(); 'withCredentials' in d ? d.open(a, b, !0) : typeof XDomainRequest !== 'undefined' ? (d = new XDomainRequest(), d.open(a, b)) : d = null; return d } function h(a, b, d) { void 0 === b && (b = e.defaultSuccessCallback); void 0 === d && (d = e.defaultErrorCallback); return c(a, b, d) } function c(a, b, d) {
    a.onreadystatechange = function() {
      a.readyState === XMLHttpRequest.DONE && a.status === 200 ? a.responseType === '' ? b(a.responseText) : b(a.response) : a.readyState === XMLHttpRequest.DONE && (d ? d(a.response)
        : console.log('error occurred with no errorCallback set.'))
    }; return a
  } var e = {}; var k = {}; var p = /^((?!chrome|android).)*safari/i.test(navigator.userAgent); navigator.userAgent.indexOf('Trident/7.0'); var l = 'http://127.0.0.1:9100/'; p && location.protocol === 'https:' && (l = 'https://127.0.0.1:9101/'); e.Device = function(a) {
    var m = this; this.name = a.name; this.deviceType = a.deviceType; this.connection = a.connection; this.uid = a.uid; this.version = 2; this.provider = a.provider; this.manufacturer = a.manufacturer; this.readRetries = this.connection ===
            'bluetooth' ? 1 : 0; this.sendErrorCallback = function(d) { }; this.sendFinishedCallback = function(d) { }; this.readErrorCallback = function(d) { }; this.readFinishedCallback = function(d) { }; this.send = function(d, a, f) {
    ...
    }; this.sendUrl = function(d, a, f, e) { var g = b('POST', l + 'write'); g && (c(m, g, a, f), d = { device: { name: this.name, uid: this.uid, connection: this.connection, deviceType: this.deviceType, version: this.version, provider: this.provider, manufacturer: this.manufacturer }, url: d }, e != null && void 0 != e && (d.options = e), g.send(JSON.stringify(d))) }; this.sendFile = function(d, a, f) {
      if (typeof d === 'string') e.loadFileFromUrl(d, function(d) { m.sendFile(d, a, f) }, f); else {
        var g = b('POST', l + 'write'); if (g) {
          g.responseType = 'text'; h(g, a, f); var c =
                            new FormData(); var n = {}; n.device = m; c.append('json', JSON.stringify(n)); c.append('blob', d); g.send(c)
        }
      }
    ...
    }; this.readUntilStringReceived = function(d, a, b, e, c) { c || (c = ''); void 0 === e && (e = this.readRetries); a = (function(a, b, e, f, g) { return function(c) { if (c && c.length !== 0) f = 0; else if (f <= 0) { b(g); return } c = g + c; d !== '' && c.indexOf(d) > -1 ? b(c) : a.readUntilStringReceived(d, b, e, f - 1, c) } }(this, a, b, e, c)); this.read(a, b) }; this.readAllAvailable = function(a, b, f) { this.readUntilStringReceived('', a, b, f) }; this.sendThenRead = function(a, b, f) { this.send(a, (function(a) { return function() { a.read(b, f) } }(this)), f) }
    ...
    var g = 'default'; void 0 !== a && a != null && (g = g + '?type=' + a); if (a = b('GET', l + g)) {
      finishedFunction =
